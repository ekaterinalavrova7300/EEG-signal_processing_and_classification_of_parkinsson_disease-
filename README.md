...
Download the bdf files provided in one single folder. Download the ipynb file in the directory where you want your results to end up and open it in Jupyter notebook.   Run the code cells from top to bottom in order. Under the Import data title, you will be asked to enter a file path. Enter the file path to where you have downloaded the bdf files provided.  Required packages are specified and downloaded inside the program. 
...
README.md 
EEG_features.csv - Output from Feature extraction cell
